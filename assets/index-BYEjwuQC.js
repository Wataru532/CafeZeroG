 ...
 */var Jv;function wT(){if(Jv)return Hl;Jv=1;var s=Symbol.for("react.transitional.element"),t=Symbol.for("react.fragment");function e(a,r,l){var c=null;if(l!==void 0&&(c=""+l),r.key!==void 0&&(c=""+r.key),"key"in r){l={};for(var f in r)f!=="key"&&(l[f]=r[f])}else l=r;return r=l.ref,{$$typeof:s,type:a,key:c,ref:r!==void 0?r:null,props:l}}return Hl.Fragment=t,Hl.jsx=e,Hl.jsxs=e,Hl}var $v;function CT(){return $v||($v=1,Gd.exports=wT()),Gd.exports}var ce=CT(),Vd={exports:{}},Gl={},kd={exports:{}},Xd={};/**
 * @license React
...
#define LOW_PRECISION`),t}function X2(s){let t="SHADOWMAP_TYPE_BASIC";return s.shadowMapType===Ky?t="SHADOWMAP_TYPE_PCF":s.shadowMapType===m1?t="SHADOWMAP_TYPE_PCF_SOFT":s.shadowMapType===Ia&&(t="SHADOWMAP_TYPE_VSM"),t}function W2(s){let t="ENVMAP_TYPE_CUBE";if(s.envMap)switch(s.envMapMode){case Po:case zo:t="ENVMAP_TYPE_CUBE";break;case Of:t="ENVMAP_TYPE_CUBE_UV";break}return t}function q2(s){let t="ENVMAP_MODE_REFLECTION";if(s.envMap)switch(s.envMapMode){case zo:t="ENVMAP_MODE_REFRACTION";break}return t}function Y2(s){let t="ENVMAP_BLENDING_NONE";if(s.envMap)switch(s.combine){case Qy:t="ENVMAP_BLENDING_MULTIPLY";break;case O1:t="ENVMAP_BLENDING_MIX";break;case P1:t="ENVMAP_BLENDING_ADD";break}return t}function j2(s){const t=s.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,a=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:a,maxMip:e}}function Z2(s,t,e,a){const r=s.getContext(),l=e.defines;let c=e.vertexShader,f=e.fragmentShader;const d=X2(e),p=W2(e),m=q2(e),g=Y2(e),v=j2(e),S=z2(e),E=I2(l),M=r.createProgram();let y,x,w=e.glslVersion?"#version "+e.glslVersion+`
